...
package com.nuxeo.studio.components.common.serializer;
...
import com.nuxeo.studio.components.common.mapper.descriptors.FacetDescriptor;
import com.nuxeo.studio.components.common.mapper.descriptors.LifeCycleDescriptor;
import com.nuxeo.studio.components.common.mapper.descriptors.PermissionDescriptor;
import com.nuxeo.studio.components.common.serializer.adapter.DefaultAdapter;
import com.nuxeo.studio.components.common.serializer.adapter.OperationAdapter;
import com.nuxeo.studio.components.common.serializer.adapter.OperationChainAdapter;
import com.nuxeo.studio.components.common.serializer.adapter.OperationScriptingAdapter;
import com.nuxeo.studio.components.common.serializer.adapter.SchemaAdapter;
import com.nuxeo.studio.components.common.serializer.adapter.SerializerAdapter;
import com.nuxeo.studio.components.common.serializer.adapter.automation.OperationDocumentation;
import com.nuxeo.studio.components.common.serializer.adapter.schema.Schema;
import com.nuxeo.studio.components.common.serializer.mixin.DocTypeMixin;
import com.nuxeo.studio.components.common.serializer.mixin.EventListenerMixin;
import com.nuxeo.studio.components.common.serializer.mixin.FacetMixin;
import com.nuxeo.studio.components.common.serializer.mixin.LifeCycleMixin;
import com.nuxeo.studio.components.common.serializer.mixin.OperationDocumentationMixin;
import com.nuxeo.studio.components.common.serializer.mixin.PermissionMixin;
import com.nuxeo.studio.components.common.serializer.mixin.SchemaMixin;
...
public class JacksonConverter {
    ...
    public String serialize(Object target) {
        try {
            ...
            // Mainly occurred with {@code com.nuxeo.studio.components.common.serializer.adapter.SchemaAdapter#adapt} when schema file
            // is
            // missing.
