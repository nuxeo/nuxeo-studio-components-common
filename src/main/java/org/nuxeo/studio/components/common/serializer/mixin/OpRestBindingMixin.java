...
@JsonSerialize(using = OpRestBindingMixin.WebServiceFilterSerializer.class)
public abstract class OpRestBindingMixin {

    public static class WebServiceFilterSerializer extends StudioJacksonSerializer<OpRestBindingDescriptor> {

        private static final long serialVersionUID = 1L;

        @Override
        public void serialize(OpRestBindingDescriptor value, JsonGenerator gen, SerializerProvider provider)
                throws IOException {
