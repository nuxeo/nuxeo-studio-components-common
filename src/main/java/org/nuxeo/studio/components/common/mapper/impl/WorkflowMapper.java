...
public class WorkflowMapper extends ExtensionMapper {

    @Override
    public void registerDescriptors() {
        registerDescriptor("workflows", WorkflowDescriptor.class);
    }

    @Override
    protected boolean accept(String target, String point) {
        return "org.nuxeo.ecm.platform.routing.service".equals(target) && "routeModelImporter".equals(point);
    }
}
