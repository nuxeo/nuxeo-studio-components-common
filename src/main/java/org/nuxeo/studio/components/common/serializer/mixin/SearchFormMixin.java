...
@JsonSerialize(using = SearchFormMixin.SearchFormSerializer.class)
public abstract class SearchFormMixin {

    public static class SearchFormSerializer extends StudioJacksonSerializer<SearchFormDescriptor> {

        private static final long serialVersionUID = 1L;

        @Override
        public void serialize(SearchFormDescriptor value, JsonGenerator gen, SerializerProvider provider)
                throws IOException {
