...
@JsonSerialize(using = DirectoryMixin.DirectorySerializer.class)
public abstract class DirectoryMixin {

    public static class DirectorySerializer extends StudioJacksonSerializer<DirectoryDescriptor> {

        private static final long serialVersionUID = 1L;

        @Override
        public void serialize(DirectoryDescriptor value, JsonGenerator gen, SerializerProvider provider)
                throws IOException {
