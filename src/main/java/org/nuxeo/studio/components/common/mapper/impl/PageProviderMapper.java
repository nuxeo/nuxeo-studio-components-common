...
public class PageProviderMapper extends ExtensionMapper {

    @Override
    public void registerDescriptors() {
        registerDescriptor("page_providers", PageProviderDescriptor.class);
    }

    @Override
    protected boolean accept(String target, String point) {
        return "org.nuxeo.ecm.platform.query.api.PageProviderService".equals(target) && "providers".equals(point);
    }
}
